...
// ¡TUS VALORES REALES DE SUPABASE ESTÁN AQUÍ!
...
async function hacerReserva(event) {
    ...
    try {
        ...
        if (clienteExistente) {
            ...
            // Opcional: Actualizar el nombre/teléfono si ya existía el email
...
// ------------------- LÓGICA DE VISUALIZACIÓN EN RECEPCIÓN -------------------
